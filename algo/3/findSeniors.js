...
function findSeniors(persons) {
  // Your code here !
  const seniorDev = persons.filter(persons => persons.experience >= 5 && persons.job === 'web dev');
  const seniorData = persons.filter(persons => persons.experience >= 5 && persons.job === 'data analyst');
